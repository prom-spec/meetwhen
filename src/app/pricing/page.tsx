...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Stripe payment collection", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "SSO / SAML (coming soon)", included: true },
      { name: "SCIM provisioning (coming soon)", included: true },
...
const faqs = [
  ...
  },
  {
    ...
    a: "We accept all major credit/debit cards via Stripe. Enterprise plans can pay by invoice.",
  },
  {
