...
import { Plus, Edit, Trash2, Copy, ExternalLink, Video, MapPin, Phone, Link2, Check, ChevronRight, X, Loader2, CalendarPlus, Share2, Repeat, ShieldCheck, Bell } from "lucide-react"
          ...
          <div className="bg-white w-full sm:max-w-2xl sm:rounded-xl sm:mx-4 max-h-[90vh] overflow-hidden flex flex-col rounded-t-xl sm:rounded-xl">
            ...
            <div className="flex-1 overflow-y-auto">
              <form id="event-type-form" onSubmit={handleSubmit} className="p-4 sm:p-6">
                ...
                {/* Duplicate screening section removed — already exists above under Advanced Settings */}
