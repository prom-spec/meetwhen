...
export const metadata: Metadata = {
  ...
  description: "letsmeet.link Privacy Policy - How we collect, use, and protect your data.",
}
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              When you use letsmeet.link, we collect the following information:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              letsmeet.link integrates with the following third-party services:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-1 mt-2">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You have the right to access, correct, or delete your personal data. You can revoke Google Calendar access at any time through your Google Account settings. To delete your letsmeet.link account and data, contact us at the address below.
            </p>
          </section>
